...
def downgrade():
    ...
    op.create_foreign_key('association_contact_id_fkey', 'association', 'contact', ['contact_id'], ['id'])
    ...
    sa.Column('secondary_email', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('cellphone', sa.VARCHAR(length=256), autoincrement=False, nullable=False),
    sa.Column('role', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('organization', sa.VARCHAR(length=256), autoincrement=False, nullable=False),
    sa.Column('neighbourhood', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('contact_type', postgresql.UUID(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['contact_type'], ['contact_types.id'], name='contact_contact_type_fkey'),
