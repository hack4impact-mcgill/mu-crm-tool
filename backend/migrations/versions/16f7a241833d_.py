...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['contact_id'], ['contact.id'], name='contacts_contact_id_fkey'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='contacts_project_id_fkey'),
